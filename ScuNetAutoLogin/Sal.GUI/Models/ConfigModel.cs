...
public partial class ConfigModel : ObservableObject
{
    ...
    [ObservableProperty] public partial int InitialDelayMs { get; set; }

    [ObservableProperty] public partial int RetryCount { get; set; }

    [ObservableProperty] public partial int RetryDelayMs { get; set; }

    public ObservableCollection<AccountModel> UserList { get; set; } = [];

    [ObservableProperty] public partial bool EnableHotspot { get; set; }

    [ObservableProperty] public partial bool ConnectSCUNETWifi { get; set; }
